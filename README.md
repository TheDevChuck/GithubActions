[![Run App CharlieMcIver](https://github.com/TheDevChuck/GithubActions/actions/workflows/run-app.yaml/badge.svg)](https://github.com/TheDevChuck/GithubActions/actions/workflows/run-app.yaml)
